/*
  ...
  - The values [BERANGKAT] on the enum `StatusPerjalanan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StatusPerjalanan_new" AS ENUM ('PERSIAPAN', 'DI_PERJALANAN', 'KEMBALI', 'SELESAI', 'DIBATALKAN');
...
ALTER TABLE "PerjalananSales" ALTER COLUMN "statusPerjalanan" SET DEFAULT 'PERSIAPAN';
COMMIT;
