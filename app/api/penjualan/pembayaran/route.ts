// =====================================================
// PATH: app/api/penjualan/pembayaran/route.ts
// =====================================================
...
// GET: Ambil data pembayaran penjualan toko (karyawanId: null)
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Base filter: hanya pembayaran untuk penjualan toko (karyawanId null), tidak dihapus
    ...
    console.error("Error fetching pembayaran penjualan:", err);
    return NextResponse.json(
      { success: false, error: "Gagal mengambil data pembayaran penjualan" },
      { status: 500 }
    );
  }
}
