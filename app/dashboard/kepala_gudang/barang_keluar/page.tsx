...
const TerjualBarangPage = () => {
  const [penjualanBarang, setPenjualanBarang] = useState<PenjualanBarang[]>(
    []
  );
  const [loading, setLoading] = useState(false);
  const [filterMode, setFilterMode] = useState<PenjualanFilterMode>("date");
  ...
  const fetchPenjualanBarang = async () => {
    ...
    try {
      ...
      toast.error("Gagal mengambil data terjual");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-lg">
                  Ringkasan barang keluar berdasarkan periode
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              <button
                onClick={fetchPenjualanBarang}
                disabled={loading}
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className="text-sm font-bold text-indigo-700">
                          {formatDecimal(row.totalTerjualKemasan)} {row.jenisKemasan}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-center">
...
export default TerjualBarangPage;
