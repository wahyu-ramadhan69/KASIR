            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  Kelola dan terima pembayaran piutang customer
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 shadow-lg border border-gray-100">
          ...
          <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-xl p-3 flex items-center gap-2">
            ...
            <span className="text-sm text-yellow-700">
              Menampilkan hanya transaksi dengan status piutang, diurutkan
              berdasarkan tanggal jatuh tempo terdekat
            </span>
          </div>
        </div>
