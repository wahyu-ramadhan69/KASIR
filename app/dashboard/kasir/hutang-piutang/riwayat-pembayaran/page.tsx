...
interface PenjualanHeader {
  ...
  karyawan: { id: number; nama: string } | null;
...
const RiwayatPembayaranHutangPage = () => {
  // Data state
  ...
  const fetchPenjualan = async (page: number = 1, reset: boolean = false) => {
    ...
    try {
      ...
      const res = await fetch(`/api/penjualan/riwayat-hutang?${queryParams}`);
      const data = await res.json();
  ...
  const fetchStats = async () => {
    try {
      ...
      const res = await fetch(
        `/api/penjualan/riwayat-hutang?${params.toString()}`
      );
      const data = await res.json();

      if (data.success) {
        setStats({
          totalPembayaran: data.summary?.totalPembayaran || 0,
          totalTransaksi: data.summary?.totalTransaksi || 0,
          totalCash: data.summary?.totalCash || 0,
          totalTransfer: data.summary?.totalTransfer || 0,
        });
      }
    } catch (error) {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-emerald-600">
                  {formatRupiahSimple(stats.totalPembayaran)}
                </p>
                <p className="text-[11px] text-gray-400">Semua pembayaran</p>
              </div>
          ...
          <div className="group bg-white rounded-xl p-4 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-gray-400">Pembayaran tercatat</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-blue-600">
                  {formatRupiahSimple(stats.totalTransfer)}
                </p>
                <p className="text-[11px] text-gray-400">Pembayaran transfer</p>
              </div>
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 shadow-lg border border-gray-100">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Cari kode pembayaran, kode penjualan, atau customer..."
                value={searchTerm}
          ...
          <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-xl p-3 flex items-center gap-2">
            ...
            <span className="text-sm text-yellow-700">
              Menampilkan riwayat pembayaran hutang, diurutkan berdasarkan
              tanggal pembayaran terbaru
            </span>
          </div>
        </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            ...
                            {/* Jika CUSTOMER → tampilkan nama toko sebagai badge hijau */}
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                            {formatDate(pj.tanggalBayar)}
                          </td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                            {formatRupiah(pj.nominal)}
                          </td>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold">
                        {selectedPenjualan.kodePembayaran}
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {new Date(
                          selectedPenjualan.tanggalBayar
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-emerald-700">
                        {formatRupiah(selectedPenjualan.nominal)}
                      </p>
                    </div>
                    <div>
...
export default RiwayatPembayaranHutangPage;
